...
class MFRC522:
    ...
    def __init__(self, sck, mosi, miso, rst, cs, baudrate=1000000):
        ...
        self.spi = machine.SoftSPI(baudrate=baudrate, sck=self.sck, mosi=self.mosi, miso=self.miso)
