    ...
    <div class="form-container">
        ...
        <form id="configForm" action="/SAVE_config" method="POST">
            ...
            <div class="section">
                <h2>Temporisation</h2>
                <div class="form-group">
                    <label for="time_to_close">Temps de fermeture (secondes):</label>
                    <input type="number" id="time_to_close" name="time_to_close" value="{time_to_close}">
                </div>
                <div class="form-group">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="PIN_CODE" name="PIN_CODE" value="{PIN_CODE}">
                </div>
            </div>
